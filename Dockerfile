...
&& apk add --no-cache --virtual .build-deps  curl build-base jpeg-dev pixman-dev cairo-dev pango-dev pangomm-dev giflib-dev freetype-dev g++ file bzip2 gzip unzip openjdk openjdk:8-jre-alpine rsync \
